...
<body class="skin-default fixed-layout">
    ...
    <div id="main-wrapper">
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-danger btn-sm">Delete</a>
                                                    <a href="javacript:void(0)" class="btn btn-warning btn-sm">Ban</a>
                                                </td>
                                            </tr>
                                            <?php    }
                                            }  }
        ...
        <!-- ============================================================== -->
        <footer class="footer">
            © 2020 CoolWallet by themedesigner.in
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
