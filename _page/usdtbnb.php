...
<header>
 ...
 <?php 
    ...
    <center>
        <div class="price">
            <img src="./img/usdtbnb.png" alt="usdtbnb" width=55 height=55>
    ...
    <center>
        <div class="third">
        <div class="ree">
        <a href="send_usdtbnb?status=usd-coin&userid=<?php echo $userid?>" title="SEND COIN">
        ...
        <div class="ree">
        <a href="receive_usdtbnb" title="RECEIVE COIN">
