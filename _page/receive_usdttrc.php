...
<header>
    ...
    <div class="card-body text-warning warning">
        <p>Only send <strong>USDT(TRC)</strong> network assets to this address othe assets will be lost forever.</p>
    </div>
</header>
 <main>
    <br>
    <center>
        <div class="namee">
            <img src="./img/usdttrc.png" alt="usdttrc" width=35 height=35>
        ...
        <img src="img/usdt-barcode.jpeg" alt="usdt scan image" width=250 height=250 />
    </center>
    <br>
 </main>
    ...
    <a class="coin card-body" href="javascript:void(0)">
        <div class="coinimg">
            <div>
                ...
                <h3 style="font-size:18px">USDT TRC(20)</h3>
            </div>
        </div>
        <div>
            ...
            <a class="coin card-body" href="javascript:void(0)">
                <div class="coinimg">
                    <div>
                        ...
                        <h3 style="font-size:18px" ><?php echo $shortenedtetherWallet;?>......</h3>
                    </div>
                </div>
