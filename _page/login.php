                ...
                ?>
                    <form class="form-horizontal form-material" id="loginform" action="#" method="POST">
                        ...
                        <div class="form-group text-center">
                            ...
                            <br>
                            <p class="text-muted bg-warning">To avoid your cool wallet from been hacked , write down in some were save that you can't forget! </p>
                            
                        </div>
                    </form>
                    <?php
                    if(isset($_POST['create_wallet'])){
                        $userid = ("CWT" .rand(203994 , 485789));
                    ...
                    <form class="form-horizontal" id="recoverform" action="#" method="POST">
                        <div class="form-group ">
							...
							<?php endif; ?>
                            <div class="col-xs-12">
                                <h3> Creat A Cool Wallet Account</h3>
                        ...
                        <div class="form-group text-center m-t-20">
                            <div class="col-xs-12">
                                <button class="btn btn-success btn-lg btn-block text-uppercase waves-effect waves-light" type="submit" name="create_wallet">Start Using Cool Wallet</button>
                            </div>
                            <br>
                            <p class="text-muted bg-warning">To avoid your cool wallet from been hacked , write down in some were save that you can't forget! </p>
