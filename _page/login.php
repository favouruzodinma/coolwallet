    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url(../assets/images/background/login-register.jpg);">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" action="_page/dashboard" method="POST">
                    ...
                    <form class="form-horizontal" id="recoverform" action="dashboard">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" type="text" required="" placeholder="Full Name"> </div>
                        </div>
                        <div class="form-group ">
                            <div class="col-xs-12">
                        ...
                        <div class="form-group text-center m-t-20">
                            <div class="col-xs-12">
                                <button class="btn btn-success btn-lg btn-block text-uppercase waves-effect waves-light" type="submit"  >Start Using Cool Wallet</button>
                            </div>
                            <br>
                            <p class="text-muted bg-warning">To avoid your cool wallet from been hacked , write down in some were save that you can't forget! </p>
