...
<header>
    ...
    <div class="card-body text-warning warning">
        <p>Onliy send <strong>Bitcoib(BTC)</strong> network assets to this address othe assets will be lost forever.</p>
    </div>
</header>
 <main>
    <br>
    <center>
        <div class="namee">
            <img src="./img/bitcoin.png" alt="btc" width=35 height=35>
        ...
        <img src="img/btcbarcode.jpg" alt="btc scan image" width=250 height=250 />
    </center>
    <br>
 </main>
    ...
    <a class="coin card-body" href="javascript:void(0)">
        <div class="coinimg">
            <div>
                ...
                <h3 style="font-size:18px">BITCOIN</h3>
            </div>
        </div>
        <div>
            ...
            <a class="coin card-body" href="javascript:void(0)">
                <div class="coinimg">
                    <div>
                        ...
                        <h3 style="font-size:18px"><?php echo $shortenedBitcoinWallet; ?>.......</h3>
                    </div>
                </div>
                <div>
