...
<header>
    ...
    <div class="card-body text-warning warning">
        <p>Only send <strong>BNB smart chain (BNB)</strong> network assets to this address othe assets will be lost forever.</p>
    </div>
</header>
 <main>
    <br>
    <center>
        <div class="namee">
            <img src="./img/bnb.png" alt="btc" width=35 height=35>
        ...
        <img src="img/bnb-barcode.jpg" alt="bnb scan image" width=250 height=250 />
    </center>
    <br>
 </main>
    ...
    <a class="coin card-body" href="javascript:void(0)">
        <div class="coinimg">
            <div>
                ...
                <h3 style="font-size:18px">BNB</h3>
            </div>
        </div>
        <div>
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        // Your data retrieval
        $shortenedBinanceWallet = shortenWalletAddress($row["binancecoin_wallet"]);
        ?>
        <center>
            <a class="coin card-body" href="javascript:void(0)">
                <div class="coinimg">
                    <div>
                        ...
                        <h3 style="font-size:18px"><?php echo $shortenedBinanceWallet; ?>.......</h3>
                    </div>
                </div>
                <div>
