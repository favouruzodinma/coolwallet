...
<header>
    ...
    <div class="card-body text-warning warning">
        <p>Only send <strong>ETHEREUM(ETH)</strong> network assets to this address othe assets will be lost forever.</p>
    </div>
</header>
 <main>
    <br>
    <center>
        <div class="namee">
            <img src="./img/etheruem.png" alt="ethereum" width=35 height=35>
            <h3 class="text-light pt-3">ETH</h3>
            <sup class="bg-dark" style="font-size:12px; background-color:blue"><small class="text-muted">COIN</small></sup> 
        </div>
        <img src="img/eth-barcode.jpg" alt="eth scan image" width=250 height=250 />
    </center>
    <br>
 </main>
    ...
    <a class="coin card-body" href="javascript:void(0)">
        <div class="coinimg">
            <div>
                ...
                <h3 style="font-size:18px">ETHEREUM</h3>
            </div>
        </div>
        <div>
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        // Your data retrieval
        $shortenedEthWallet = shortenWalletAddress($row["etheruem_wallet"]);
        ?>
        <center>
            <a class="coin card-body" href="javascript:void(0)">
                <div class="coinimg">
                    <div>
                        ...
                        <h3 style="font-size:18px"><?php echo $shortenedEthWallet; ?>.......</h3>
                    </div>
                </div>
                <div>
