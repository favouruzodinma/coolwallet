...
<header>
 ...
 <main>
    ...
    <center>
        <div class="namee">
            <img src="./img/tron.png" alt="tron" width=35 height=35>
            <h3 class="text-light pt-3">TRON</h3>
            <sup class="bg-dark" style="font-size:12px; background-color:blue"><small class="text-muted">COIN</small></sup> 
        </div>
        <img src="img/tron-barcode.jpeg" alt="tron scan image" width=250 height=250 />
    </center>
    <br>
 </main>
    ...
    <a class="coin card-body" href="javascript:void(0)">
        <div class="coinimg">
            <div>
                ...
                <h3 style="font-size:18px">TRON</h3>
            </div>
        </div>
        <div>
