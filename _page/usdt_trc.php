...
<header>
 ...
 <?php 
    ...
    <center>
        <div class="price">
            <img src="./img/usdttrc.png" alt="usdttrc" width=55 height=55>
    ...
    <center>
        <div class="third">
        <div class="ree">
        <a href="send_usdttrc?status=tether&userid=<?php echo $userid?>" title="SEND COIN">
        ...
        <div class="ree">
        <a href="receive_usdttrc" title="RECEIVE COIN">
